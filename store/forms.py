...
class LaptopForm(forms.ModelForm):
    class Meta:
        model = Laptop
        fields = [
            "brand", "model", "processor", "storage_capacity", "max_storage_capacity",
            "ram", "max_ram_upgrade", "supported_os", "battery_health", "battery_backup",
            "screen_size", "resolution", "graphics_type", "total_graphics_memory",
            "dedicated_video_memory", "shared_system_memory", "hdmi", "webcam", "wifi",
            "keypad_light", "touchscreen", "optical_drive", "vga_output", "sd_card_reader",
            "usb_ports", "condition", "price", "discount", "available",
